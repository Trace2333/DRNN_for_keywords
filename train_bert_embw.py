...
if_load = True
if os.path.exists(check_point + '\\DRNN_parms_8232037.pth') and if_load is True:    # 参数加载
    model.load_state_dict(torch.load(check_point + '\\DRNN_parms_8232037.pth'))
    print("Parms loaded!!!")
...
torch.save(model.state_dict(), ".\\check_points\\DRNN_parms_8232037.pth")
