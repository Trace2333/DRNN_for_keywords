...
from general_code.models.DRNN_bert_replace_RNN1 import DRNNBertReplaceRNN
from general_code.dataset.for_bert_replace_RNN1 import RNNdatasetForBertReplaceRNN, collate_fun_for_bert_replace_rnn
from general_code.utils.evalTools import acc_metrics, recall_metrics, f1_metrics
from general_code.utils.data_process_for_bert import get_list


def trainer_bert_replace_RNN(args):
